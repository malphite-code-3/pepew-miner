...
int scanhash_0x10(int thr_id, struct work *work, uint32_t max_nonce, uint64_t *hashes_done);
...
#define CL_YL2  "\x1B[00;33m" /* yellow */
#define CL_LYL  "\x1B[01;33m" /* yellow */
#define CL_LYL2  "\x1B[07;33m" /* light yellow2 */
